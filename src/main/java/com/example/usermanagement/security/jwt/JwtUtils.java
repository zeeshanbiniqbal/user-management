...
public class JwtUtils {
	...
	@Value("${example.usermanagement.security.jwt.jwtSecret}")
	private String jwtSecret;

	@Value("${example.usermanagement.security.jwt.jwtExpirationMs}")
...
//	}
	...
	public Boolean validateToken(String token, String userNameFromRequest) {
		...
		return (userNameFromToken.equals(userNameFromRequest) && !isTokenExpired(token));
	}
